...
namespace GestionBundle\Entity\Repository\GestionBundleSegViale\opciones;

use GestionBundle\Entity\Entity\GestionBundleSegViale\opciones\TipoHabilitacionUnidad;
